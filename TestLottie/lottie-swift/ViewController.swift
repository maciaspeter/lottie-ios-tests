...
//
//    let switchButton = AnimatedSwitch()
//    switchButton.animation = Animation.named("brightness", subdirectory: "TestAnimations")
//    switchButton.translatesAutoresizingMaskIntoConstraints = false
//
//    /// Set the play progress for `On` and `Off`
//    switchButton.setProgressForState(fromProgress: 0.0, toProgress: 1, forOnState: true)
//    switchButton.setProgressForState(fromProgress: 1, toProgress: 0.0, forOnState: false)
//
//
//
//    view.addSubview(switchButton)
...
//
    ...
    //twitterButton.setPlayRange(fromProgress: 0, toProgress: 1.0, event: .touchUpInside)
    twitterButton.addTarget(self, action:#selector(hi), for: .touchUpInside)
    //let targets = twitterButton.allTargets
...
//    /// Set an animation on the button.
//    testButton.animation = Animation.named("test", subdirectory: "TestAnimations")
//    testButton.setPlayRange(fromMarker: "Hi", toMarker: "Bye", event: .touchDown)
//    /// Turn off clips to bounds, as the animation goes outside of the bounds.
//    testButton.clipsToBounds = false
//    view.addSubview(testButton)
//    testButton.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 12).isActive = true
//    testButton.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 20).isActive = true
    
//        let testButton = AnimatedButton()
//        testButton.translatesAutoresizingMaskIntoConstraints = false
//        /// Set an animation on the button.
//        testButton.animation = Animation.named("brightness", subdirectory: "TestAnimations")
//        testButton.setPlayRange(fromMarker: "dark", toMarker: "light", event: .touchDown)
//        /// Turn off clips to bounds, as the animation goes outside of the bounds.
//        testButton.clipsToBounds = false
//        view.addSubview(testButton)
//        testButton.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 12).isActive = true
